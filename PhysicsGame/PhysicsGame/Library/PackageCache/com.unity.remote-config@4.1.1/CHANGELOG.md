...
## [4.1.0-pre.1] - 2023-12-04
Changed
- Added dropdown for assigning schema to a JSON key in JSON modal
- Updated documentation for JSON schema

Fixed
- Misleading "No content fetched" message when fetching in an empty directory with reconcile on
