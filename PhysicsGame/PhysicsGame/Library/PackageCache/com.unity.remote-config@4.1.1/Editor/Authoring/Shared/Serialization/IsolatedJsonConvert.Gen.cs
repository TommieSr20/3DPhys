...
namespace Unity.Services.RemoteConfig.Authoring.Editor.Shared.Serialization
{
    // Copy of Newtonsoft.JsonConvert with references to JsonSerializer.CreateDefault replaced with JsonSerializer.Create
