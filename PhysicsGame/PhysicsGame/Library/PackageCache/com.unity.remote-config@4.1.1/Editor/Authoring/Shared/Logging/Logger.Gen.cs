...
namespace Unity.Services.RemoteConfig.Authoring.Editor.Shared.Logging
{
    static class Logger
    {
        const string k_Tag = "[RemoteConfig]";

        const string k_VerboseLoggingDefine = "ENABLE_UNITY_REMOTE_CONFIG_VERBOSE_LOGGING";
