...
![click_edit_json_setting](images/click_edit_json_setting.png)
...
Each template has its own value, which represent the set of rules for validating the JSON Setting.
